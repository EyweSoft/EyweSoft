 ...
 */
    ...
    $.jstree.core.prototype = {
        ...
        redraw_node: function(node, deep, is_callback, force_render) {
            ...
            if(obj.state) {
            	node.setAttribute("mType", obj.state.mType);
            }
        ...
        select_node: function(obj, supress_event, prevent_open, e) {
            ...
            if (!obj.state.selected) {
                ...
                //选中父节点时，只有打开的父节点下的子节点才会同时被选中
                var selectChildren = dom.hasClass('jstree-open');
                if(selectChildren) {
                ...
                if(typeof selectNode === "function") {
                	selectNode(obj, true, selectChildren, this.settings.core.multiple);
                }
            }
        ...
        deselect_node: function(obj, supress_event, e) {
            ...
            if (obj.state.selected) {
                ...
                if(typeof selectNode === "function") {
                	selectNode(obj, false, selectChildren, this.settings.core.multiple);
                }
            }
        ...
        get_top_selected: function(full) {
            ...
            j = tmp.length; i < j; i++) {
                for (k = 0,
                l = tmp[i].children_d.length; k < l; k++) {
        ...
        move_node: function(obj, par, pos, callback, is_loaded, skip_redraw, origin) {
            ...
            if (obj.parent === new_par.id) {
                ...
                for (i = 0,
                j = new_par.parents.length; i < j; i++) {
                    this._model.data[new_par.parents[i]].children_d = this._model.data[new_par.parents[i]].children_d.concat(tmp)
                }
                dpc = [];
                for (i = 0,
                j = new_par.children.length; i < j; i++) {
    ...
    $.jstree.plugins.checkbox = function(options, parent) {
        this.bind = function() {
            ...
            if (this.settings.checkbox.three_state) {
                ...
                this.settings.checkbox.cascade = "down+undetermined"//去除取消子节点时，不去取消父节点
            }
            ...
            if (this.settings.checkbox.cascade.indexOf("up") !== -1 || this.settings.checkbox.cascade.indexOf("down") !== -1) {
                this.element.on("model.jstree", $.proxy(function(e, data) {
                    ...
                    tmp = [];
                    for (i = 0,
                    j = this._data[t ? "core" : "checkbox"].selected.length; i < j; i++) {
                    ...
                    //当子节点全部取消选项后，顶级节点也取消选项
                    var tmp = this.get_checked(true);
                    if(tmp && tmp.length == 1 && tmp[0].id == '-1') {
                    	this.uncheck_node('-1');
                    }
        ...
        this.check_all = function() {
            ...
            for (i = 0,
            j = this._data.checkbox.selected.length; i < j; i++) {
    ...
    $(function() {
        ...
        $(document).on("dnd_start.vakata.jstree", function(e, data) {
            ...
            if (lastmv) {
                for (i = 0,
                j = data.data.nodes.length; i < j; i++) {
