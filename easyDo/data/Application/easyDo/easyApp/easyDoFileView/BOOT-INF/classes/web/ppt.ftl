...
<div class="container-fluid" style="max-height: 100%;">
    <div class="row-fluid">
        <div class="span2 hidden-phone"
             style="position: fixed; top:0px; left: 20px; bottom:0px; padding-right: 10px;padding-top:10px;padding-bottom:10px; border-right:1px solid #c8c8c8; max-height: 100%; overflow: auto; text-align: center;">
        </div>
