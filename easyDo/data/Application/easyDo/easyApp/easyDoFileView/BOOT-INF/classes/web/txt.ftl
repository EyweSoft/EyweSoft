...
.divContent{color:#000;font-size：30px；
line-height：30px；
font-family：“SimHei”；
text-indent:2em;padding-bottom:10px;white-space:pre-wrap;white-space:-moz-pre-wrap;white-space:-pre-wrap;white-space:-o-pre-wrap;word-wrap:break-word;}
input{
color:#ffffff;
