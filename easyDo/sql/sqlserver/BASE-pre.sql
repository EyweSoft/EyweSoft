...
create table sys_role (
	...
	filterField VARCHAR(MAX),
	tabRight VARCHAR(MAX),
	isSystem varchar(2),
	isValid varchar(2) default 'Y',
	creatorId varchar(36), 
	createdTime datetime, 
